...
class Ruleset:
    ...
    def evaluate(self, realization: Realization):
        ...
        explained = [False] * len(partimento.bass.pitches) # we tick all progression that have followed a particular rule as explained
        for pitch_idx in range(len(partimento.bass.pitches) - 1):
